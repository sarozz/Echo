...
const EN: Strings = {
  ...
  'settings.backend.auto':      'AUTO · WI-FI MESH (RECOMMENDED)',
  'settings.backend.nearby':    'NEARBY (ANDROID · WI-FI)',
  'settings.backend.multipeer': 'MULTIPEER (IOS · WI-FI)',
  'settings.backend.ble':       'BLE FALLBACK · SHORT RANGE ~30M',
  'settings.language':    'LANGUAGE',
  'settings.location':    'SHARE LOCATION',
  'settings.location.body': 'Broadcast your GPS coords to your group as encrypted LOCATION frames. Off by default.',
  'settings.location.on':   'ON',
...
const NE: Strings = {
  ...
  'settings.backend.auto':      'स्वतः · वाई-फाई मेस (सिफारिस)',
  'settings.backend.nearby':    'NEARBY (एन्ड्रोइड · वाई-फाई)',
  'settings.backend.multipeer': 'MULTIPEER (IOS · वाई-फाई)',
  'settings.backend.ble':       'BLE फलब्याक · छोटो दूरी ~३० मि',
  'settings.language':    'भाषा',
  'settings.location':    'स्थान साझेदारी',
  'settings.location.body': 'समूहलाई आफ्नो GPS निर्देशांक एन्क्रिप्टेड LOCATION फ्रेममा प्रसारण गर्नुहोस्। पूर्वनिर्धारित: निष्क्रिय।',
  'settings.location.on':   'सक्रिय',
  'settings.location.off':  'निष्क्रिय',
